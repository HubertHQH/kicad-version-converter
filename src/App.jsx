  ...
  return (
    <div className="app-container">
      ...
      <footer className="app-footer">
        <a href="https://www.huaqiu.com" target="_blank" rel="noopener">华秋</a> KiCad 版本转换器 • 支持 .kicad_sch、.kicad_sym、.kicad_pcb 和 .kicad_mod • KiCad 5 输出采用 legacy .sch 和 .lib/.dcm 格式 • 有损转换 — 高版本特有功能将被移除
      </footer>
    </div>
  )
}
